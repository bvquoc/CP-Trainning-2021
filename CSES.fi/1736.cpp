...
const int N = 200005;
int n, q;
ll a[N], st[N * 4], lazy1[N * 4], lazy2[N * 4];
...
void downLazy(int id, int l, int r){
    int mid = (l + r) / 2;
    push(id * 2, l, mid, lazy1[id], lazy2[id]);
    push(id * 2 + 1, mid + 1, r, lazy1[id], lazy2[id]);
    lazy1[id] = lazy2[id] = 0;
}
...
ll get (int id, int l, int r, int u, int v){
    ...
    downLazy(id, l, r);
    int mid = (l + r) / 2;
    ll lf = get(id * 2, l, mid, u, v);
    ll rt = get(id * 2 + 1, mid + 1, r, u, v);
    return (lf + rt);
}
